    ...
    protected void processMovie(DBObject obj, BasicDBObject newMovieObject) {
        ...
        if (searchResultList != null) {
            ...
            if (result != null) {
                ...
                movieDetails.append("id", result.getId().getVideoId())
                        .append("description", result.getSnippet().getDescription()).append("thumbnailURL", result.getSnippet().getThumbnails().getDefault().getUrl())
