...
public class IMDBSearch implements Runnable {
	...
	public IMDBSearch() throws UnknownHostException {
		...
		DBObject objM = new BasicDBObject()
				.append("movieKey", "goneGirlSmreki");
		movies.remove(objM);
		movies.insert(objM);
		...
		DBObject obj = new BasicDBObject().append("movieKey", "goneGirlSmreki")
				.append("imdbId", "tt2267998");
